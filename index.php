...
<div class= "ads">
    <img src="data:image/jpeg;base64,'.base64_encode($row['photos'] ).'" height="300" width="200" class="img-thumnail"/>'.'
      ...
      <p class="blinking">Price : 12.99</p>
</div>';
} 
					
$conn->close();
echo '<text align="center">&nbspTotal Records Found '.$count.'</text>';
?> 
</div>
<!--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<img src="images\ad1.gif" width="500px" />
               <img src="images\ad1.gif" width="500px"/>
          <p align="center">Total Records Found '.$count.'</p>     <img src="images\ad1.gif"width="500px" />
               <img src="images\ad1.gif" width="500px"/>
               <img src="images\ad1.gif"  width="500px"/>
</div>
</div>
