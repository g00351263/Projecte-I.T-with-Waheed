         ...
         <div class="column">
            ...
            <div class="main">
               <?php
                  ...
                  <tr>
                  <td id="sizephoto" style="width:55%"><img src="data:image/jpeg;base64,'.base64_encode($row['photos'] ).'" height="200" width="200" class="img-thumnail"/>'.'
                  </td>
                  
                  	<td id="td1"><b>Description : '.$field1name. '</b><br/><br>
                  </td>
                  </tr>
                  
                  
                  <tr>
                  <td><b>Category : '.$field1name. '<br><span class="blinking">Price</span> : ' .$field3name.'</b><br/><br>
                  </td>
                  	<td><b>Contact : ' .$field3name. '</b><br/><br>
                  </td>
                  </tr>
                  </table></div><br>';
            ...
            <marquee style="align: center; font-family: Book Antiqua; color: #FFFFFF" bgcolor="#000080"  direction="down">
               <p align="center">Here is your 1 Stop Shop for <br>Galway City</p>
            </marquee>
         </div>
         <div class="column1">
